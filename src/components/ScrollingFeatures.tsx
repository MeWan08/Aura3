...
export function ScrollingFeatures() {
  ...
  return (
    <section ref={containerRef} className="relative w-full py-24 px-6 bg-[#0a0a0a] overflow-hidden">
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute top-0 left-0 w-[520px] h-[520px] bg-gradient-to-br from-[#03e1ff]/10 to-transparent rounded-full blur-[120px]" />
        <div className="absolute bottom-0 right-0 w-[520px] h-[520px] bg-gradient-to-tl from-[#00ffbd]/10 to-transparent rounded-full blur-[120px]" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        <div className="text-center mb-20">
          ...
          <h2 className="text-4xl md:text-5xl font-headline font-black uppercase tracking-tight text-white mb-4">
              ...
              >
                <div
                  className={`flex-1 transition-all duration-700 ${
                    isInView ? 'opacity-100 translate-y-0' : 'opacity-45 translate-y-4'
                  }`}
                  style={{
                ...
                >
                  ...
                  <p className="text-on-surface-variant text-lg leading-relaxed mb-6">{feature.description}</p>
                </div>
                ...
                >
                  <div className="relative">
                    <div className="bg-black border border-[#03e1ff]/30 rounded-lg overflow-hidden shadow-[0_0_40px_rgba(3,225,255,0.16)]">
                      <div className="bg-[#0f1418] px-4 py-3 border-b border-[#03e1ff]/20 flex items-center gap-2">
                      ...
                      <div className="bg-[#0f1418] px-6 py-2 border-t border-[#03e1ff]/20 text-[10px] font-mono text-[#7defff] uppercase tracking-wider">
